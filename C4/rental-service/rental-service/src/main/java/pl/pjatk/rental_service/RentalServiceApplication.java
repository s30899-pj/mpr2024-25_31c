...
//		Hire hire1= new Hire(1,"Jan","Kowalski", LocalDate.of(2024,12,1),LocalDate.of(2024,12,3), car1);
//		rentalOffice.hireCar(hire1);
//		Hire hire2= new Hire(2,"Natan","Nowak", LocalDate.of(2024,12,5),LocalDate.of(2024,12,10), car1);
//		rentalOffice.hireCar(hire2);
//		Hire hire3= new Hire(2,"Igor","Tartak", LocalDate.of(2024,12,10),LocalDate.of(2024,12,20), car1);
//		rentalOffice.hireCar(hire3);
//		Hire hire4= new Hire(2,"Radek","Nowacki", LocalDate.of(2024,12,22),LocalDate.of(2024,12,25), car1);
